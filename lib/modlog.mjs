...
import { PunishTypes, PunishTexts, PunishColors } from "./modlog/constants.mjs";
import { v4 as createUUID } from "uuid";
import config from "../config.js";
import { getGuildConfig, t } from "./util.mjs";
...
class ModLog {
    ...
    async makeLogMessage(userID, ctx, punishment, oldObject) {
        ...
        return await channel.createMessage({
            ...
            embeds: [this.templateMessage(punishment, user, ctx.author, oldObject)],
        });
    }
